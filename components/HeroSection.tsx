...
const HeroSection: React.FC = () => {
  return (
    <section className="relative h-screen min-h-[600px] w-full flex items-center justify-center bg-hero-pattern md:bg-hero-desktop bg-cover bg-center bg-no-repeat bg-scroll md:bg-fixed">
